...
5. **Run ResNet50 experiment**. Run the following command to exectue the experiments for the ResNet in Fig 8. `python run_fig8.py ResNet50_v2-8`. More concretely this script does the following:
