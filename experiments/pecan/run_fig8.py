...
_, pecan_out, _ = get_exitcode_stdout_stderr(cost_extract_cmd.format('logs/pecan.log', 'resnet', 'pecan'))
_, cachew_out, _ = get_exitcode_stdout_stderr(cost_extract_cmd.format('logs/cachew.log', 'resnet', 'cachew'))
_, colloc_out, _ = get_exitcode_stdout_stderr(cost_extract_cmd.format('logs/colloc.log', 'resnet', 'collocated'))
