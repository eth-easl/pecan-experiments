...
class Parser(object):
  ...
  def __call__(self, image, value):
    ...
    with tf.name_scope('parser'):
      ...
      print(type(image))
      print(type(value))
      return self._parse_fn(image, value)

  def _parse_train_data(self, image, data):
  ...
  def _parse_eval_data(self, image, data):
    """Parses data for training and evaluation."""
    groundtruths = {}
    classes = data['groundtruth_classes']
    boxes = data['groundtruth_boxes']
  ...
  def _parse_predict_data(self, image, data):
