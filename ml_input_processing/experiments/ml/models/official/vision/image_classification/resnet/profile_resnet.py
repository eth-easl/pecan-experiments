...
dataset = dataset.map(lambda image, label: (imagenet_preprocessing._resize_image(image, DEFAULT_IMAGE_SIZE, DEFAULT_IMAGE_SIZE), label), tf.data.experimental.AUTOTUNE, keep_position=False)
